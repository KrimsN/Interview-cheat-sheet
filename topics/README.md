...
Здесь лежат подборки «что нужно знать + ссылки» по темам, которые уже
переписаны в основные разделы репозитория. Черновики оставлены как быстрые
подборки ссылок на документацию, но актуальный текст — в готовых разделах.
