# Черновые темы — что доучить

Здесь лежат подборки «что нужно знать + ссылки» по темам, которые ещё не
переписаны в основные разделы репозитория.

## Разделы

- [Go](go/README.md) — полная карта тем для собеседования по Go: язык,
  конкурентность, рантайм и GC, инструменты, стандартная библиотека,
  типовые вопросы и задачи. 24 темы, все со ссылками на официальную
  документацию.
