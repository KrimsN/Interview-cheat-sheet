...
Список тем, которые слабо или совсем не покрыты в [python.md](../python.md)
...
Это черновой материал для последующего наполнения `python.md` /
`python_examples.md`, а не готовые шпаргалки — ссылки нужно будет прочитать
и переписать выжимку своими словами в основном файле.
