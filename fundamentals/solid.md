...
[← Связи между классами](oop-relations.md) · [🏠 Домой](../README.md) · [Принципы проектирования →](principles.md)
...
**Подвох.** DIP путают с dependency injection. DI — техника (передать
зависимость в конструктор вместо создания внутри), DIP — принцип направления
зависимостей. Можно внедрять зависимость через конструктор и всё равно
